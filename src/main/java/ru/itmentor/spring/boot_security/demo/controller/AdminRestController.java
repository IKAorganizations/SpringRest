...
import ru.itmentor.spring.boot_security.demo.util.UserNotCreatingException;
...
public class AdminRestController {
    ...
    public ResponseEntity<HttpStatus> addUser (@RequestBody @Valid User user, BindingResult bindingResult) {
        if(bindingResult.hasErrors()){
            ...
            throw new UserNotCreatingException(errorMsg.toString());
        }
    ...
    @ExceptionHandler
    private ResponseEntity<UserErrorResponse> handlerException(UserNotCreatingException e){
